...
%% DETERMINE HEAVIEST STRUCTURE WEIGHT
    ...
    inputs.GeometryOutput.AR       = zeromat;
    ...
    inputs.GeometryOutputs.AR       = inputs.GeometryOutput.AR+boolmat.*DesignOutput.GeometryOutput.AR;
    ...
    inputs.GeometryOutput.AR       = inputs.GeometryOutput.AR+boolmat.*MediumOutput.GeometryOutput.AR;
    ...
    inputs.GeometryOutput.AR       = inputs.GeometryOutput.AR+boolmat.*FerryOutput.GeometryOutput.AR;
